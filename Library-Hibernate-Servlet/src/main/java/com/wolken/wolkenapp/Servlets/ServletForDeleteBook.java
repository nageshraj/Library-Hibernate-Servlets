...
@WebServlet(urlPatterns = "/deleteBook", loadOnStartup = +1)
public class ServletForDeleteBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String bookNameToBeDeleted = req.getParameter("bookNameToDelete");

		libraryService.ValidateAndDeleteBookByBookName(bookNameToBeDeleted);
